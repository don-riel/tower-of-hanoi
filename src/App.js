    ...
    return (
      <div className="App">
        <small className="notice">
          Notice: This site does not work yet on mobile devices!
        </small>
        {/* Header */}
        <div className="title">
          <h1>ower of Hanoi</h1>
        ...
        <div className="how-to-play-box">
          <p className="btn-how-to-play" onClick={showHowToPlayInfo}>
            How to Play?
          </p>
          <div className="how-to-play-info">
            <Bounce top>
              <div className="pop-up how-to-play-txt ">
                <p>
                  Transfer the bars to the rightmost tower in the same sorted
                  order.
                </p>
        ...
        {this.state.isSolved ? (
          <Bounce top>
            <div className="pop-up pop-up-solved">
              ...
              <div className=" btn btn-play-again" onClick={onPlayAgain}>
                Play Again?
              </div>
            </div>
          </Bounce>
        ...
        <div className="btn-box">
          <div className="btn-item-box">
            ...
            <div className="btn-item-count">
              <p className="btn" onClick={onIncreaseClick}>
                <FontAwesomeIcon icon={faAngleUp} /> Add{" "}
              </p>
              <p className="btn" onClick={onDecreaseClick}>
                <FontAwesomeIcon icon={faAngleDown} /> Minus{" "}
              </p>
            </div>
